#include <stdio.h>
#define MAX 5 // Define a small maximum size for easy demonstration
...
void display() {
    if (top == -1) {
        printf("The stack is empty. (Top = %d)\n", top);
    } else {
        printf("Stack status: (Top = %d)\n", top);
...
int main() {
    ...
    while (1) {
        ...
        printf("3. Display the stack status\n");
        printf("4. Exit\n");
