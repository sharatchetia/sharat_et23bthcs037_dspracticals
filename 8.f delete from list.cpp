...
void deleteFromEnd(struct Node** head) {
    ...
    if ((*head)->next == NULL) {
        ...
        *head = NULL; // Update head to NULL
        printf("Deleted the node from the end of the list. The list is now empty.\n");
        return;
    }
    ...
    printf("Deleted the node from the end of the list.\n");
}
...
int main() {
    ...
    // Delete another node from the end
    deleteFromEnd(&head);
    displayList(head);
